function [T,T1,T2,Height,FN,body_v,theta,theta_dot,LegLength]= Right_Leg(x,x_dot,pitch,pitch_dot,Joint1_theta,Joint1_thetadot,Joint2_theta,Joint2_thetadot,LegLength_ref,x_ref,x_dot_ref,accx,accy,WheelVel,theta_error,theta_dot_error)
...
%% 全局变量
% global theta_dot_rlast;
% global LegLength_dot_rlast;
global FN_r;
global l_active_leg;
global l_slave_leg;
...
%% 驱动轮支持力解算
% delta = 0.01;
% theta_ddot = (theta_dot-theta_dot_rlast)/delta;
% leglen_ddot = (LegLength_dot-LegLength_dot_rlast)/delta;
% theta_dot_rlast = theta_dot;
% LegLength_dot_rlast = LegLength_dot;
